"""
it is a python script ,used to Extract and Display the specific frame from a video.
Example = suppose there is a video which is 40 sec long and has 600 total frame .now i want to extract only single image / frame from video,  we can use this function
"""
import cv2
import numpy as np
